...
START_WELCOME = (
    "<b>Бот команди @UaAniSub</b>\n"
    ".\n\n"
    "Для покупки скористайтесь посиланням з каналу команди."
)
...
BUY_INSTRUCTION = (
    ...
    "Сума: <b>{price}</b>\n"
    "Код: <code>{code}</code>\n\n"
    "Натисніть «Перейти до оплати» — сума й код у коментарі підставляться автоматично.\n\n"
